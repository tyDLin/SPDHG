    ...
    for idx_method = 1:length(funfcn_stoc)
        ...
        for idx_runs = 1:num_runs
            for idx_trace = 1:length(stoc_data.trace_time(:,idx_runs))
                trace_accuracy(idx_trace,idx_method,idx_runs)   = stoc_data.trace_accuracy(idx_trace,idx_runs);
                trace_time(idx_trace,idx_method,idx_runs)       = stoc_data.trace_time(idx_trace,idx_runs);
                trace_passes(idx_trace,idx_method,idx_runs)     = stoc_data.trace_passes(idx_trace,idx_runs);
                trace_obj_val(idx_trace,idx_method,idx_runs)    = stoc_data.trace_obj_val(idx_trace,idx_runs);
                trace_test_loss(idx_trace,idx_method,idx_runs)  = stoc_data.trace_test_loss(idx_trace,idx_runs);
            end
        end
    end
